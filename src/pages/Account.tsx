...
const Account = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-800 py-12 px-4 md:px-8">
      <div className="container mx-auto">
        ...
        <div className="max-w-4xl mx-auto">
          <Tabs defaultValue="settings" className="w-full">
            <TabsList className="w-full bg-gray-700 border border-gray-600 mb-8">
              <TabsTrigger value="settings" className="flex-1 data-[state=active]:bg-gray-600">
                <Settings className="mr-2 h-4 w-4" />
                {t('account.settings')}
              </TabsTrigger>
              <TabsTrigger value="profile" className="flex-1 data-[state=active]:bg-gray-600">
                <User className="mr-2 h-4 w-4" />
                {t('account.profile')}
              </TabsTrigger>
              <TabsTrigger value="details" className="flex-1 data-[state=active]:bg-gray-600">
            ...
            <TabsContent value="settings">
              <Card className="border-2 border-gray-600 backdrop-blur-sm bg-gray-700">
                <CardHeader>
                  <CardTitle className="text-white">{t('account.appearance')}</CardTitle>
                </CardHeader>
            ...
            <TabsContent value="profile">
              <Card className="border-2 border-gray-600 backdrop-blur-sm bg-gray-700">
                <CardHeader>
                  <CardTitle className="text-white">{t('account.profile.title')}</CardTitle>
                </CardHeader>
                <CardContent>
            ...
            <TabsContent value="details">
              <Card className="border-2 border-gray-600 backdrop-blur-sm bg-gray-700">
                <CardHeader>
                  <CardTitle className="text-white">{t('account.details.title')}</CardTitle>
                </CardHeader>
                <CardContent>
                  <p className="text-gray-300">
